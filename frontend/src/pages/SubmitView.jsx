            ...
            <div class="flex items-center justify-center h-screen">
                <div className="mx-auto">
                    <div role="status" class="flex justify-center">
                        <svg aria-hidden="true" class=" w-2/6 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
