    ...
    return (
        <div className="flex flex-col justify-center items-center max-md:px-5">
            <div className="flex w-[346px] max-w-full flex-col items-stretch mt-72 mb-52 max-md:my-10">
                ...
                />
                <button className="forgot-button max-md:mt-10" onClick={onResetPasswordClick}>
                    RESET PASSWORD
                </button>
                <button className="back-to-login-button mt-14 max-md:mt-10" onClick={onBackToLoginClick}>
                    BACK TO LOGIN
                </button>
            </div>
        </div>
