    ...
    <div className="flex flex-col justify-center items-center h-dvh">
      <div className="flex w-[350px] max-w-full flex-col items-stretch mt-25 max-md:my-10">
        ...
        <div className="flex items-stretch justify-between gap-5 mt-12 max-md:mt-10">
          <button
            className="text-white tracking-[0.52px] whitespace-nowrap bg-[#6a7dc2] w-6/12 justify-center px-[46px] py-[22px] rounded-md border-2 border-solid border-[#6a7dc2] max-md:px-5 text-sm font-bold"
