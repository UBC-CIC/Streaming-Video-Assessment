...
import {handleSignIn} from "../helpers/authenticationApi"
...
function LoginView() {
  ...
  const onLoginClick = async () => {
    ...
    if(!nextStep.signInStep === 'DONE'){
      ...
      alert("challenge needs to be completed");
      return;
    }
    if(!isSignedIn){
      isAuthenticating(false);
  ...
  //           <svg
  //             aria-hidden="true"
  //             className="w-2/6 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
  //             viewBox="0 0 100 101"
  //             fill="none"
